package com.miscko.hotel_service.dto;
...
public class RoomInfoResponse {
    ...
    public RoomInfoResponse(Long roomId, Long hotelId, Long tariffId, BigDecimal basePrice,
                            BigDecimal multiplier, Integer cancellationPenaltyPercent) {
        this.roomId = roomId;
